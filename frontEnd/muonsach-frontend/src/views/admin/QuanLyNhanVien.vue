            ...
            <tr v-for="nv in filteredStaff" :key="nv._id || nv.MSNV || nv.msnv">
              ...
              <td class="text-end pe-4">
                <div class="d-inline-flex gap-2">
                  ...
                  <button class="btn btn-sm btn-outline-danger rounded-3 px-2.5 py-1" @click="confirmDeleteNhanVien(nv)" title="Xóa">
        ...
        <div class="modal-content rounded-4 border-0 shadow text-center p-3">
          <div class="modal-body">
            ...
            <div class="d-flex gap-2">
              ...
              <button type="button" class="btn btn-danger rounded-pill flex-fill fw-bold text-white" @click="executeDeleteNhanVien">Xóa</button>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    openModalToEdit(nv) {
      ...
      // Xử lý Ngày Sinh chuẩn YYYY-MM-DD cho input date
      let formattedDate = "";
      ...
      // Điền đầy đủ dữ liệu cũ của nhân viên vào form
      this.currentNV = {
        _id: nv._id,
    ...
    async saveNhanVien() {
      ...
      // Đồng bộ các thuộc tính dữ liệu
      const payload = {
      ...
      // Giữ nguyên mật khẩu cũ nếu người dùng không nhập mật khẩu mới
